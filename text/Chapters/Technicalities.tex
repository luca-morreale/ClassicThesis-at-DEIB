...
There is a set of commands to refer to chapters, sections, subsections, appendices, figures, tables and equations, like \verb!\myChap{label_key}! to produce \chapref{aChapter}.
There are also capital versions of the commands (\verb!\chapref{}! produces \chapref{aChapter}).
...
\begin{verbatim}
	...
	\end{figure}
\end{verbatim}
which produces things like \figref{massConstraintFeasibility}. 
...
\figlabel{massConstraintFeasibility}
\end{figure}
...
\begin{verbatim}
	...
	\end{table}
\end{verbatim}
which produces \tabref{tab:MOEAandParameters}.
...
\begin{equation}
	...
	e^{i\pi}+1=0.
\end{equation}
From \eq{euler} you can see how \verb!\eq{euler}! should be used.
